...
//        for ( Map.Entry<Integer, Measurements> entry : stats.entrySet()) {
//            if (entry.getKey() <= day) {
//                measurements.cost += entry.getValue().cost;
//            }
//        }
    ...
    /**
     * Get the measures for a particular day if they exist or create an empty
     * measures object if they don't.
    ...
    /**
     * Get a string representation of the statistics in the form of a CSV of the time and
     * measurements.
     * @return the string.
     */
    @Override
    public final String toString() {
        ...
        sb.append("Farms Confirmed, Farms Culled, Farms Vaccinated, Cost\n");
     ...
     */
    private static final long serialVersionUID = 131879930019376504L;
}
